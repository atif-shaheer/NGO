...
<!-- Mirrored from sanatandharmajagruti.in/aboutus.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:30 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="css/about-us67b4.css?v=1726033887">
    <link rel="stylesheet" href="css/index67b4.css?v=1726033887">
  </head>
  <style>
  .pdf_container h1{
  text-align:center;
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">About Us</span></div>
        <div class="main">
      <div class="paragraph">
        <span>                <p><strong>संगठन के बारे में.......</strong><br />
                नवयान जीवन परिवर्तन फाउंडेशन ने नवयान परिवार सदस्यता अभियान के तहत देश के गांव के सभी परिवार को संस्था का सदस्य (Member) और परिवार डाटा पहचान पत्र (Family Data Identity Document) बना रहा है जिसका उद्देश्य है सरकारी और गैर सरकारी योजनाओं और कार्यक्रमों को गांव के अंतिम परिवार और व्यक्ति तक पहुंचाना और समुदायों को स्थिर दिशा मे एकजुट करना है।</p>

<p><strong>परिवार डाटा पहचान पत्र से लाभ</strong><br />
1. गांव के परिवारों के सदस्यों का व्यावसायिक, शैक्षणिक, सरकारी योजनाओं का डाटा इकट्ठा किया जायेगा इस आकड़ा के आधार पर फांउडेशन द्वारा सरकारी और गैर सरकारी योजनाओं का लाभ देने में सहयोग करेगा।<br />
2. 6 से 14 वर्ष के आयु के बच्चों को अबेकस प्रशिक्षण निशुल्क दिया जायेगा।<br />
3. सरकारी योजनाओं में सहायक दस्तावेज जैसे फैमिली आईडी कार्ड, लेबर कार्ड आदि दस्तावेजों का निशुल्क पंजीकरण किया जायेगा।
<br />
4. सरकारी और गैर सरकारी योजनाओं की जानकारी वॉलिंटियर, व्हाटसएप, मैसेज के माध्यम से देना।<br />
5. बेरोजगार युवाओं को रोजगार और गैर सरकारी संस्थाओं और कंपनी में नौकरी मे सहायक ।<br />
6. पंजीकृत परिवार के महिलाओं हेतु कौशल विकास कार्यक्रम का संचालन करना।<br />
7. महिला पैड बैंक योजना के तहत पंजीकृत परिवार के महिलाओं को किफायती पैड प्रदान करना।<br />
8. IN PARIVARIA सामाजिक सुरक्षा योजनाओं की जानकारी देना और लाभ प्राप्त करने में सहायता करना।
<br />
9. निशुल्क बाइक सर्विस।<br />
10. किसान के किसान सम्मान निधि जैसे समस्याओं का कैंप के माध्यम से समाधान किया जायेगा।<br />
11. किसान के किसान सम्मान निधि जैसे समस्याओं का कैंप के माध्यम से समाधान किया जायेगा।<br />
12. किसानों का भूमि परीक्षण किया जायेगा और मृदा स्वास्थ्य कार्ड बनाया जायेगा।</p>

<p><strong>नवयान खेती किसानी योजना के मुख्य उदेश्य :</strong><br />
1. हानिकारक रसायनों से बंजर होती भूमि को बचाना।<br />
2. किसानो को जागरूक और प्रशिक्षित करना, जैविक खेती अपनाने में मदद करना एवं अवांछित हानियों से बचाना।<br />
3. कृषि लागत को कम करना।<br />
4. कृषि उत्पादन में वृद्धि करना।<br />
5. जीवन परिवर्तन की • 100% जैविक फसल के लिए उचित बजार और उचित दाम दिलवाने में मदद करना।<br />
</p>

<p><strong>जैविक सूचना से किसानों के लाभ</strong><br />
1. किसानों को खेती किसानी योजना मे जोड़ना।<br />
2. किसान के खेत की मिट्टी और पानी की जांच करना।<br />
3. फसल की जांच करना।<br />
4. किसान गोष्ठी के माध्यम से किसानों को जागरूक करना।<br />
5. सही बीज की जानकारी देना।<br />
6. मौसम के हिसाब से खाद, दवाओं को डालने का सही तरीका बताना।<br />
7. लागत को कम करना।<br />
8. पैदावार को बढ़ाना।<br />
9. नकली खाद, दवाओं से बचाना।<br />
10. सरकारी योजनाओं को किसान तक पहुँचाना।<br />
11. फसल का सही दाम दिलाना।</p>
</span>
      </div>
            <div class="container main_contant">
        <div class="row">
          <div class="col-md-6">
            <div class="image">
              <img src="webimg/pre.jpeg">
            </div>
          </div>
          <div class="col-md-6">
            <div class="text">
              <h2>नवयान परिवार सदस्यता अभियान</h2>
              <p><p>नवयान जीवन परिवर्तन फाउंडेशन ने नवयान परिवार सदस्यता अभियान के तहत देश के गांव के सभी परिवार को संस्था का सदस्य (Member) और परिवार डाटा पहचान पत्र (Family Data Identity Document) बना रहा है जिसका उद्देश्य है </p>

<p>सरकारी और गैर सरकारी योजनाओं और कार्यक्रमों को गांव के अंतिम परिवार और व्यक्ति तक पहुंचाना और समुदायों को स्थिर दिशा मे एकजुट करना है।</p>
</p>
            </div>
          </div>
        </div>
    ...
    <!--      <img src="document/2_page-0001.jpg" width="100%" height="auto">-->
    <!--      <img src="document/2_page-0002.jpg" width="100%" height="auto">-->
    <!--    </div>-->
    <!--    <div class="col-md-6">-->
    <!--      <h1>Order For Provisional Registration</h1>-->
    <!--    </div>-->
    <!--  </div>-->
      
    <!--  <div class="row mb-5">-->
    <!--    <div class="col-md-6" style="height:400px; overflow-y:scroll;">-->
    <!--      <img src="document/3_page-0001.jpg" width="100%" height="auto">-->
    <!--      <img src="document/3_page-0002.jpg" width="100%" height="auto">-->
    <!--    </div>-->
    <!--    <div class="col-md-6">-->
    <!--      <h1>Order For Provisional Registration</h1>-->
    <!--    </div>-->
    ...
    <!--  <div class="row mb-5">-->
    <!--    <div class="col-md-6" style="height:400px; overflow-y:scroll;">-->
    <!--      <img src="document/4_page-0001.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0002.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0003.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0004.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0005.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0006.jpg" width="100%" height="auto">-->
    <!--      <img src="document/4_page-0007.jpg" width="100%" height="auto">-->
    <!--    </div>-->
    <!--    <div class="col-md-6">-->
    <!--      <h1>Order For Provisional Registration</h1>-->
    <!--    </div>-->
    ...
    <!--  <div class="row mb-5">-->
    <!--    <div class="col-md-6" style="height:400px; overflow-y:scroll;">-->
    <!--      <img src="document/5_page-0001.jpg" width="100%" height="auto">-->
    <!--      <img src="document/5_page-0002.jpg" width="100%" height="auto">-->
    <!--      <img src="document/5_page-0003.jpg" width="100%" height="auto">-->
    <!--      <img src="document/5_page-0004.jpg" width="100%" height="auto">-->
    <!--      <img src="document/5_page-0005.jpg" width="100%" height="auto">-->
    <!--    </div>-->
    <!--    <div class="col-md-6">-->
    <!--      <h1>Order For Provisional Registration</h1>-->
    <!--    </div>-->
    ...
    <!--  <div class="row mb-5">-->
    <!--    <div class="col-md-6" style="height:400px; overflow-y:scroll;">-->
    <!--      <img src="document/6.jpg" width="100%" height="auto">\-->
    <!--    </div>-->
    <!--    <div class="col-md-6">-->
    <!--      <h1>Order For Provisional Registration</h1>-->
    <!--    </div>-->
...
<!-- Mirrored from sanatandharmajagruti.in/aboutus.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:31 GMT -->
</html>