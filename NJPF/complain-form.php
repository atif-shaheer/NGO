...
<!-- Mirrored from sanatandharmajagruti.in/complain-form.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:36 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title>Complain / Suggestion</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    

<link href="https://fonts.googleapis.com/css2?family=Acme&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css/mainb1e5.css?v=1726033889">
<script src="../code.jquery.com/jquery-2.2.4.min.js"></script>
<link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="preconnect" href="https://fonts.gstatic.com/">
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css-loader-master/dist/css-loaderb1e5.css?v=1726033889">
...
<style>
    ...
    <link rel="stylesheet" href="css/user-formb1e5.css?v=1726033889">
    <link rel="stylesheet" href="css/indexb1e5.css?v=1726033889">
...
$(document).ready(function() {
    ...
    <div class="head_item3"><span class="mt-3">Complain / Suggestion</span></div>
    <div class="container mt-3  main-div"
        style="border-radius:10px;border:1px solid grey; background:white; margin-bottom: 80px;">
        <div class="container mt-5">
            <form class="" id="Complain_form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" placeholder="Mobile No." name="mobile" value="">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">Message<span id="red">*</span> :</label>
                        </div>
                        <div class="col-md-9">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">Description<span id="red">*</span> :</label>
                        </div>
                        <div class="col-md-9">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">Video Url<span id="red">*</span> :</label>
                        </div>
                        <div class="col-md-9">
                            <textarea name="url" class="form-control" placeholder="Video URL"
                                maxlength="250"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">Upload Documents<span id="red">*</span> :</label>
                        </div>
						<div class="col-md-3">
						    <div class="upload_image_main_div bg-image-div bg-image-div-hover"><label for="image1" class="empty_image_div"><span><i class="fa fa-plus" aria-hidden="true"></i></span><span>Upload</span></label><input class="image_file_input"  id="image1" type="file" name="Image" accept="image/*"><div class="upload_preview_div upload_preview_div_none"><div class="preview_image_div_box"><img class="preview_image_div_box_img" src="#"><div class="upload_img_control"><i class="fa fa-eye view-image" aria-hidden="true"></i><i class="fa fa-trash-o delete-image" aria-hidden="true"></i></div></div></div></div>						</div>                        
                        <div class="col-md-3">
                            <label for="">Upload Documents<span id="red">*</span> :</label>
                        </div>
						<div class="col-md-3">
						    <div class="upload_image_main_div bg-image-div bg-image-div-hover"><label for="image2" class="empty_image_div"><span><i class="fa fa-plus" aria-hidden="true"></i></span><span>Upload</span></label><input class="image_file_input"  id="image2" type="file" name="Image1" accept="image/*"><div class="upload_preview_div upload_preview_div_none"><div class="preview_image_div_box"><img class="preview_image_div_box_img" src="#"><div class="upload_img_control"><i class="fa fa-eye view-image" aria-hidden="true"></i><i class="fa fa-trash-o delete-image" aria-hidden="true"></i></div></div></div></div>						</div>
                    </div>
                </div>
                <div class="form-group">
                    <center><button type="submit" id="submit" class="btn btn-grad sub-btn pl-4 pr-4 pt-2 pb-2 mb-2"
                            name="button">Register</button></center>
                </div>
            </form>
        </div>
    </div>
...
सनातन धर्म जागृति सेना एक � <a style="text-decoration:none;" href="aboutus.php">read more ..</a></p>-->
    ...
    $(document).ready(function() {
        ...
        $(document).on("submit", "#Complain_form", function(e) {

            e.preventDefault()
            $('.loader').addClass('is-active');
            var data = $(this).serialize()
            $.ajax({
                url: "ajax/insert-complain-form.php",
                type: "POST",
...
<!-- Mirrored from sanatandharmajagruti.in/complain-form.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:37 GMT -->
</html>