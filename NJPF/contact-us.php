...
<!-- Mirrored from sanatandharmajagruti.in/contact-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:28 GMT -->
...
<link rel="stylesheet" href="css/main67b4.css?v=1726033887">
<script src="../code.jquery.com/jquery-2.2.4.min.js"></script>
<link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="preconnect" href="https://fonts.gstatic.com/">
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css-loader-master/dist/css-loader67b4.css?v=1726033887">
...
<style>
    ...
    <link rel="stylesheet" href="css/user-form67b4.css?v=1726033887">
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">Contact Us</span></div>
    <div class="container mt-3  main-div" style="border-radius:10px;border:1px solid grey; background:white; margin-bottom: 80px;">
        <div class="container mt-5">
            <form class="" id="conatact_form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" pattern="[1-9]{1}[0-9]{9}" title="Please enter exactly 10 digits"
                                name="Mobile" required value="" class="form-control" placeholder="Number">
                        </div>
                    </div>
                </div>
                <div class="line-all">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="">Topic<span id="red">*</span> :</label>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea name="Description" class="form-control" placeholder="Description" maxlength="250"
                                required></textarea>
                        </div>
                    </div>
                </div>
...
<script>
CKEDITOR.replace('Description.php');
</script>
<script>
CKEDITOR.replace('Description.php');
$(document).ready(function() {

    $(document).on("submit", "#conatact_form", function(e) {
        ...
        $.ajax({
            url: "ajax/insert-contact-us.php",
            type: "POST",
            data: data,
...
<!-- Mirrored from sanatandharmajagruti.in/contact-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:30 GMT -->
</html>