...
<!-- Mirrored from sanatandharmajagruti.in/coordinator-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:39 GMT -->
...
<link rel="stylesheet" href="css/maine367.css?v=1726033891">
<script src="../code.jquery.com/jquery-2.2.4.min.js"></script>
<link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="preconnect" href="https://fonts.gstatic.com/">
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css-loader-master/dist/css-loadere367.css?v=1726033891">
...
<style>
    ...
    <link rel="stylesheet" href="css/admin-logine367.css?v=1726033891">
    <link rel="stylesheet" href="css/indexe367.css?v=1726033891">
</head>
...
$(document).ready(function() {
    ...
    <div class="w-50  main-div " style="padding:20px;background:white; margin:150px auto 50px auto">
        <h1 class="text-center text-info login-title mt-4">COORDINATOR LOGIN</h1>
        <form id="coordinator_form">
            ...
            <div class="form-group">
                ...
                <div class="g-recaptcha" id="captcha" style="margin-top:20px;"
                    data-sitekey="6LcStWAoAAAAANkLTSRrc9ts_sd_w5jZ9LjZViU5"></div>
                <span id='invalid'></span><br>
                <input type="submit" class="btn btn-grad mt-2" name="login" value="Login">
...
सनातन धर्म जागृति सेना एक � <a style="text-decoration:none;" href="aboutus.php">read more ..</a></p>-->
    ...
    <script>
    $(document).ready(function() {
        $(document).on('submit', '#coordinator_form', function(e) {
            e.preventDefault();
            $.ajax({
                url: 'ajax/coordinator-login.php',
                type: 'post',
                data: $(this).serialize(),
                success: function(data) {
                    ...
                    if (data == 4) {
                        ...
                        var invalid = $('#invalid').html('You are deactive By Admin');
                        if ($('#invalid').html('You are deactive By Admin'))
                            setTimeout(function() {
                                $('#invalid').html('');
                            }, 3000);
                    } else if (data == 2) {
...
<!-- Mirrored from sanatandharmajagruti.in/coordinator-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:40 GMT -->
</html>