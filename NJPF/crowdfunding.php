...
<!-- Mirrored from sanatandharmajagruti.in/upcoming-event.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:24 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="css/objective2602.css?v=1726033886">
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">Upcoming Event</span></div>
    ...
    <div class="main">
            ...
            <div class="row motive_main_div">
                <div class="col-md-5 p-0">
                    ...
                    <div class="image">
                        <img src="testinomial-img/s1.jpeg">
                    </div>
                ...
                <div class="col-md-7">
                    <div class="text">
                        <div class="sticky-top ">
                            <div class="detail d-flex justify-content-between align-item text-secondary">
                            <p><b>Location - नई दिल्ली </b></p>
                            <p><b>Date - December 1, 2023 at 12:00 AM</b></p>
                        </div>
                        <h2>सदस्य अभियान </h2>
                        </div>
                        <div class="description"><p>&nbsp;</p>

<p>नवयान जीवन परिवर्तन फाउंडेशन ने नवयान परिवार सदस्यता अभियान के तहत देश के गांव के सभी परिवार को संस्था का सदस्य (Member) और परिवार डाटा पहचान पत्र (Family Data Identity Document) बना रहा है जिसका उद्देश्य है सरकारी और गैर सरकारी योजनाओं और कार्यक्रमों को गांव के अंतिम परिवार और व्यक्ति तक पहुंचाना और समुदायों को स्थिर दिशा मे एकजुट करना है।</p>

<!-- <p>जय जय श्री राम।।</p> -->
</div>
                                <div class='Crowdfunding_btn'>
                                
                               <form method="post" action="https://sanatandharmajagruti.in/book-seat.php" style='float: left;'>
                                    <input type="hidden" name="Title" value="" />
                                    <a onclick="this.parentNode.submit()"><button type="button" class="btn btn-primary">Book
                                            Seat</button>
                                    </a>
                                </form>
                                </div>
            ...
            <div class="row motive_main_div">
                ...
                <div class="col-md-7">
                    <div class="text">
                        <div class="sticky-top ">
                            <div class="detail d-flex justify-content-between align-item text-secondary">
                            <p><b>Location - सम्पूर्ण भारत </b></p>
                            <p><b>Date - January 1, 2024 at 12:00 AM</b></p>
                        </div>
                        <h2>सनातन धर्म जागृति सेना </h2>
                        </div>
                        <div class="description"><p>सनातन धर्म, संस्कृति और राष्ट्र हित मे संगठन के सदस्य बने।</p>
...
<!-- Mirrored from sanatandharmajagruti.in/upcoming-event.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:25 GMT -->
</html>