...
<!-- Mirrored from sanatandharmajagruti.in/donation_form.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:25 GMT -->
...
<link rel="stylesheet" href="css/main2602.css?v=1726033886">
<script src="../code.jquery.com/jquery-2.2.4.min.js"></script>
<link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="preconnect" href="https://fonts.gstatic.com/">
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css-loader-master/dist/css-loader2602.css?v=1726033886">
...
<style>
    ...
    <link rel="stylesheet" href="css/user-form2602.css?v=1726033886">
...
$(document).ready(function() {
    ...
    <div id="myModal" class="modal">
        ...
        <div class="head_item3"><span class="mt-3">Donate Form</span></div>
            ...
            <form id="user_form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" required name="F_name" value="" class="form-control"
                        ...
                        <div class="col-md-3">
                            <input type="text" required name="mobile" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="" class="form-control"
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="">Email (optional)<span id="red"></span>:</label>
                        </div>
                        <div class="col-md-3">
                            <input type="email" name="email" value="" class="form-control" placeholder="Email">
                        </div>
                        <div class="col-md-3">
                            <label for="">Pancard No. (optional)<span id="red"></span>:</label>
                        </div>
                        <div class="col-md-3">
                            <input type="text" name="pancard" value="" class="form-control" placeholder="Pancard Number">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
						<label for="">Photo (optional)<span id="red"></span>:</label>
						</div>
						<div class="col-md-3">
						    <div class="upload_image_main_div bg-image-div bg-image-div-hover"><label for="photo_id" class="empty_image_div"><span><i class="fa fa-plus" aria-hidden="true"></i></span><span>Upload</span></label><input class="image_file_input"  id="photo_id" type="file" name="photo" accept="image/*"><div class="upload_preview_div upload_preview_div_none"><div class="preview_image_div_box"><img class="preview_image_div_box_img" src="#"><div class="upload_img_control"><i class="fa fa-eye view-image" aria-hidden="true"></i><i class="fa fa-trash-o delete-image" aria-hidden="true"></i></div></div></div></div>						</div>
                        <div class="col-md-3">
                            <label for="">Amount<span id="red">*</span>:</label>
                        </div>
                        
                        <div class="col-md-3">
                            <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="amount"  required value="" class="form-control" placeholder="Amount" >
                        </div>
                ...
                <div class="form-group">
                    <center><button type="submit" id="submit" class="btn btn-grad sub-btn pl-4 pr-4 pt-2 pb-2 mb-2"
                            name="button">Donate</button></center>
                </div>
            </form>
        </div>
    </div>
...
<!-- Mirrored from sanatandharmajagruti.in/donation_form.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:26 GMT -->
</html>