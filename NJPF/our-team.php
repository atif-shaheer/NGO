...
<!-- Mirrored from sanatandharmajagruti.in/donars.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:26 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title>Our Team Member</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--<link rel="stylesheet" href="css/donars.css?v=1726033887">-->
    <link rel="stylesheet" href="css/index67b4.css?v=1726033887">
    <link rel="stylesheet" href="css/card_style67b4.css?v=1726033887">
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">Donors</span></div>
...
सनातन धर्म जागृति सेना एक � <a style="text-decoration:none;" href="aboutus.php">read more ..</a></p>-->
    ...
    $(document).ready(function() {
        function load_data(){
             ...
             $.ajax({
                url: "ajax/ajax-donar-search.php",
                type: "POST",
                data: {
                    search: search_item
                },
                success: function(data) {
                    $(".card_main_div").html(data);
                }
            });
        }
        load_data();
...
<!-- Mirrored from sanatandharmajagruti.in/donars.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:28 GMT -->
</html>