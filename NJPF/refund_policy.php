...
<!-- Mirrored from sanatandharmajagruti.in/refund_policy.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:48 GMT -->
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">Refund Policy</span></div>

      <div class="main">
    <div class="container">
      <div class="row">
      <p><p><strong>धनवापसी और रद्दीकरण नीति</strong><br />
Sanatan Dharma Jagruti Development Council really values your contributions towards our socio-cultural causes.</p>

<p>Donations: As a policy, we do not provide any refunds on donations. Please contact us at sanatandharmajagruti@gmail.com for any special-case requests.</p>

<p>Membership: All membership fees is non-refundable. To cancel your annual membership subscription, please send a request to sanatandharmajagruti@gmail.com. The subscription will be canceled at your request starting from the next billing cycle at the beginning of the calendar year.</p>
</p>
      </div>
    </div>
