...
<!-- Mirrored from sanatandharmajagruti.in/user-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:38 GMT -->
...
<link rel="stylesheet" href="css/main992c.css?v=1726033890">
<script src="../code.jquery.com/jquery-2.2.4.min.js"></script>
<link rel="stylesheet" href="../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

<link rel="preconnect" href="https://fonts.gstatic.com/">
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="css-loader-master/dist/css-loader992c.css?v=1726033890">
...
<style>
    ...
    <link rel="stylesheet" href="css/admin-login992c.css?v=1726033890">
    <link rel="stylesheet" href="css/index992c.css?v=1726033890">
</head>
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        if (hrefLastPart === lastPart) {
            ...
            $(this).closest('li').addClass('active');
    		    ...
    		    <div class="w-50 mx-auto main-div" style="padding:20px;background:white; margin:130px auto 50px auto;">
        <h1 class="text-center text-info login-title mt-4">USER LOGIN</h1>
        <form class="" id="form_submit" method="post">
            ...
            <div class="form-group">
                ...
                <input type="submit" class="btn btn-grad mt-4" name="login1" value="Login">

                <!--  <p id="forgot" class="float-right mr-3 mt-5 font-weight-light"> If you forgot your password <a href="verify-user-login.php" class="text-primary">Click Here</a> </p> -->
            </div>
        </form>
    </div>
...
<!-- Mirrored from sanatandharmajagruti.in/user-login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:39 GMT -->
</html>