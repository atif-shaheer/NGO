...
<!-- Mirrored from sanatandharmajagruti.in/user-registration.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2024 05:52:38 GMT -->
...
$(document).ready(function() {
    ...
    $('.sidenav2 .dropdown a').each(function() {
        ...
        <div class="head_item3"><span class="mt-3">User Registration</span></div>
            ...
            <form id="user_form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="Name" required value="" class="form-control" placeholder="Full Name">
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">Password<span id="red"> *</span> :</label>
                        </div>
                        <div class="col-md-3">
                            <input type="password" name="Password" value="" placeholder="Password" class="form-control">
                        </div>
                        <div class="col-md-3">
                            <label for="">Confirm Password<span id="red"> *</span> :</label>
                        </div>
                        <div class="col-md-3">
    ...
    $(document).on('submit', '#user_form', function(e) {
        ...
        $.ajax({
            url: "ajax/insert-user-registration.php",
            type: "post",
